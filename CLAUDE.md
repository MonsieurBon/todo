...
not derive. Not the analysis that led there — the measurements, the run ids, the account of what
was tried. Keep it short, and do not rewrite it every round; it is not reviewed. The same holds for
an answer to a review: a line or two per point saying what was done, or why it wasn't. Where
evidence settles a contested point, cite the number, not the working.
